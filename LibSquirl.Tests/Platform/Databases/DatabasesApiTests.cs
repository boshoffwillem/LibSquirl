...
public class DatabasesApiTests
{
    ...
    public async Task ListAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases", handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task CreateAsync_SendsCorrectRequest()
    {
        ...
        Database result = await api.CreateAsync(new CreateDatabaseRequest
        {
            Name = "my-db",
            Group = "default"
        });
    ...
    public async Task CreateAsync_WithSeed_SerializesSeed()
    {
        ...
        await api.CreateAsync(new CreateDatabaseRequest
        {
            Name = "my-db",
            Group = "default",
        ...
        JsonDocument body = JsonDocument.Parse(handler.Requests[0].Body!);
        Assert.Equal("database", body.RootElement.GetProperty("seed").GetProperty("type").GetString());
        Assert.Equal("source-db", body.RootElement.GetProperty("seed").GetProperty("name").GetString());
    ...
    public async Task GetAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal("my-db", result.Name);
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db",
    ...
    public async Task CreateTokenAsync_SendsCorrectRequest()
    {
        ...
        TokenResponse result = await api.CreateTokenAsync(
            "my-db", expiration: "1d", authorization: "full-access");
    ...
    public async Task InvalidateTokensAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal(HttpMethod.Post, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/auth/rotate",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task GetStatsAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/stats",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task ListInstancesAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/instances",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task GetInstanceAsync_SendsCorrectRequest()
    {
        ...
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/instances/primary",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task GetConfigurationAsync_SendsCorrectRequest()
    {
        ...
        var result = await api.GetConfigurationAsync("my-db");

        Assert.Equal("256mb", result.SizeLimit);
        Assert.True(result.AllowAttach);
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/configuration",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task UpdateConfigurationAsync_SendsCorrectRequest()
    {
        ...
        var result = await api.UpdateConfigurationAsync("my-db", new() { SizeLimit = "512mb", BlockWrites = true });
    ...
    public async Task GetUsageAsync_SendsCorrectRequest()
    {
        ...
        var result = await api.GetUsageAsync("my-db");
        ...
        Assert.Equal(HttpMethod.Get, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/usage",
            handler.Requests[0].Uri.AbsolutePath);
    }
    ...
    public async Task UploadDumpAsync_SendsCorrectRequest()
    {
        ...
        using MemoryStream stream = new(System.Text.Encoding.UTF8.GetBytes("CREATE TABLE test (id INT);"));
        Database result = await api.UploadDumpAsync("my-db", stream);

        Assert.Equal("my-db", result.Name);
        Assert.Equal(HttpMethod.Post, handler.Requests[0].Method);
        Assert.Equal($"/v1/organizations/{OrgSlug}/databases/my-db/upload",
            handler.Requests[0].Uri.AbsolutePath);
    }
}
